...
GPIO.setup(29, GPIO.OUT) ## Setup GPIO Pin 21 to OUT
...
def write(char):
    ...
    printtape(state)
    for j in range(0,20):
        GPIO.output(7,True)## Switch off pin 7
        GPIO.output(29,True)## Switch off pin 7                                  
        time.sleep(0.02)   
        GPIO.output(7,False)## Switch off pin 7
        GPIO.output(29,False)## Switch off pin 7                                  
        time.sleep(0.02)                                                       
...
def printtape(s):
    ...
    if(printing):
        ...
        lcd.lcd_puts(''.join(str(e) for e in displayed),1)
        temp = displayed[p]
        displayed[p] = '^'
        lcd.lcd_puts(''.join(str(e) if str(e) == '^' else " " for e in displayed),2)
        displayed[p] = temp
...
printing = True
tape = "e e 0 a 1 a 0 c 0 b 0 b 1 c 1 C 0 c 0 a 1 a 0 c 0 b 0 b 1 c 1 C 0 c 1 a 0 a 0 c 0 b 0 b 1 c 1 C 0 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ".split()
